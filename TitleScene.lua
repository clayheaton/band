...
function TitleScene:initialize(scene_name)
  ...
  local button_start = Button("button_start", "Play", {80, 80, 255}, color_white, button_font, startNewGame, winW * 0.75, winH * 0.85, winW * 0.2, winH * 0.1)
  table.insert(self.buttons, button_start)

  local button_quit = Button("button_quit", "Quit", {255, 80, 80}, color_white, button_font, quitGame, winW * 0.25 - winW * 0.2, winH * 0.85, winW * 0.2, winH * 0.1)
